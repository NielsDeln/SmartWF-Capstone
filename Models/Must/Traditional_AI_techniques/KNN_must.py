...
knn_param_grid = {
    'n_neighbors': [1,2, 3, 5, 7, 10, 12, 15, 17, 20, 22, 25, 27, 30],
...
plot_label_pred_2D(all_data, predictions=None, title='KNN Regressor',STDeV=all)
plot_err_2D(ground_truth, predictions, title='KNN Regressor',STDeV=all, error_type='relative')

plot_mean_error(ground_truth, predictions, title='KNN Regressor', variant='Windspeed', error_type='relative')
plot_mean_error(ground_truth, predictions, title='KNN Regressor', variant='STDeV', error_type='relative')
plt.show()