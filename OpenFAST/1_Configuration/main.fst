...
---------------------- INPUT FILES ---------------------------------------------
"config_elastodyn.dat"       EDFile          - Name of file containing ElastoDyn input parameters (quoted string)
"unused"                     BDBldFile(1)    - Name of file containing BeamDyn input parameters for blade 1 (quoted string)
"unused"                     BDBldFile(2)    - Name of file containing BeamDyn input parameters for blade 2 (quoted string)
"unused"                     BDBldFile(3)    - Name of file containing BeamDyn input parameters for blade 3 (quoted string)
"config_inflow.dat"          InflowFile      - Name of file containing inflow wind input parameters (quoted string)
"config_aerodyn.dat"         AeroFile        - Name of file containing aerodynamic input parameters (quoted string)
"config_servodyn.dat"        ServoFile       - Name of file containing control and electrical-drive input parameters (quoted string)
