...
plot_label_pred_2D(ground_truth, predictions, title='Random Forest Regressor\nLeq_y', STDeV=all)
plot_err_2D(ground_truth, predictions, title='Random Forest Regressor\nLeq_y', STDeV=0.25, error_type='relative')
plot_err_2D(ground_truth, predictions, title='Random Forest Regressor\nLeq_y', STDeV=0.25, error_type='absolute')


# plot_mean_error(ground_truth, predictions, title='Random Forest Regressor\nLeq_y', variant='Windspeed', error_type='relative')
